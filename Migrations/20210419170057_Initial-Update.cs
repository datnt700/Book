    ...
    public partial class InitialUpdate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2001, 4, 20, 0, 0, 56, 669, DateTimeKind.Local).AddTicks(1769), "Nguyen Van A", "123", 0, "admin" },
                    { 2, new DateTime(1991, 4, 20, 0, 0, 56, 670, DateTimeKind.Local).AddTicks(2537), "Nguyen Van B", "123", 1, "user" }
                });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "BookId", "Author", "CategoryId", "Description", "Image", "Title" },
                values: new object[] { 1, null, 1, "Abc", null, "ABC" });
