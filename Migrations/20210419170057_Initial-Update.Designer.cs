...
namespace LibraryBook.Migrations
{
    ...
    [Migration("20210419170057_Initial-Update")]
            ...
            modelBuilder.Entity("LibraryBook.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            DoB = new DateTime(2001, 4, 20, 0, 0, 56, 669, DateTimeKind.Local).AddTicks(1769),
                            Name = "Nguyen Van A",
                            Password = "123",
                            Role = 0,
                            Username = "admin"
                        ...
                        {
                            UserId = 2,
                            DoB = new DateTime(1991, 4, 20, 0, 0, 56, 670, DateTimeKind.Local).AddTicks(2537),
                            Name = "Nguyen Van B",
                            Password = "123",
                            Role = 1,
                            Username = "user"
